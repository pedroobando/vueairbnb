<template>
  <div id="home">
    <!-- <img class="circular" :src="backgroundUrl" alt=""> -->
    <header
      ...
      <a href="/">
        <h1>
          ...
          <svg viewBox="0 0 1000 1000" role="presentation" aria-hidden="true" focusable="false" style="height:32px;width:32px;display:block;fill:#ffffff">
            <title>AirBnb</title>
      ...
      <div class="max-w-5xl mx-auto lg:py-32 py-2">
        <h2 class="lg:text-5xl text-4xl font-semibold text-white leading-none mb-4">
        ...
        <div class="flex items-center flex-wrap justify-start max-w-2xl lg:mx-0 mx-auto">
          <div class="lg:pr-5 w-full lg:w-1/2 mb-4 lg:mb-0">
            ...
            <a href="#" class="transition bg-white px-10 py-3 rounded font-bold hover:bg-gray-300 block w-full text-center border-2 border-white">
              Expore
            </a>
          </div>
          ...
          <div class="lg:pl-5 w-full lg:w-1/2">
            ...
            <a href="#" class="transition bg-transparent px-10 py-3 rounded font-bold hover:bg-gray-800 text-white block w-full text-center border-2 border-white">
              Host
            </a>
          </div>
    ...
    <div class=" max-w-5xl mx-auto lg:py-16 py-12 lg:px-0 px-4">
      ...
      <form action="#" class="lg:mb-16 mb-10">
        <div class="flex item-start justify-start flex-wrap">
        ...
        <div class="flex flex-wrap items-start justify-start">
          <div class="lg:w-1/4 w-full lg:mb-0 mb-6" v-for="(tfooter, findice) in footer" :key="findice" :id="`footer-item-${findice}`">
            ...
            <ul class="leading-loose">
              <li v-for="subtitle in tfooter.subtitle" :key="subtitle.name" class="flex">
                <a href="#" class="text-gray-600 hover:underline font-semibold">{{subtitle.name}}</a>
                <span v-if="subtitle.new" class="bg-cyan px-1 inline-flex items-center h-5 text-white rounded ml-1 mt-1 inline-block bg-black text-xs">New</span>
              </li>
            </ul>
...
import backgroundUrl from '@/assets/images/airbnb-home.jpg'
export default {
  name: 'Home',
  components: {},
  data() {
  ...
  methods: {
    margenesArticulos: function(nroarticulo) {
      let retval = 'lg:w-1/3 w-full lg:mb-0 mb-6';
      if(nroarticulo == 0) {
        retval += ' lg:pr-4';
      }
      if(nroarticulo == 2) {
